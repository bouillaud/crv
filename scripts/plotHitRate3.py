...
npot = 1e7*float(sys.argv[3]) ## number of protons on target *10^7
...
trigWinStart = 250 ## in nanoseconds
...
totalHitRate = len(dE[(dE>energyCut) & (t>trigWinStart)])/simTime
...
upOuter = bunch1_seg[(bunch1_hod==0) & (bunch1_cry==0) & (bunch1_dE>energyCut) & (bunch1_ts_real>=trigWinStart)] 
upInner = bunch1_seg[(bunch1_hod==0) & (bunch1_cry==1) & (bunch1_dE>energyCut) & (bunch1_ts_real>=trigWinStart)]
doOuter = bunch1_seg[(bunch1_hod==1) & (bunch1_cry==0) & (bunch1_dE>energyCut) & (bunch1_ts_real>=trigWinStart)]
doInner = bunch1_seg[(bunch1_hod==1) & (bunch1_cry==1) & (bunch1_dE>energyCut) & (bunch1_ts_real>=trigWinStart)]
...
# plt.show()
plt.savefig("../plots/counterHitRates3_cut{}_{}.pdf".format(energyCut, outFileStem), bbox_inches='tight')
